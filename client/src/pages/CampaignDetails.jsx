                    ...
                    <div>
                        ...
                        <div className='mt-[20px] flex flex-row items-center flex-wrap gap-[14px]'>
                            ...
                            <div>
                                ...
                                <p className='mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]'>{numberOfCampaigns} Campaigns</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className='mt-[20px] flex flex-col gap-4'>
                            {donators.length > 0 ? donators.map((item, index) => (
                                ...
                                <p className='font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify'>No Donators Yet. Be the one!</p>
                            )}
                        </div>
                    </div>
                </div>
